...
## Contents
- [Writing Dart API Documentation](#writing-dart-api-documentation)
  - [Contents](#contents)
  ...
  - [Examples](#examples)
    - [1. Banned Tags vs. Prose](#1-banned-tags-vs-prose)
    - [2. The Annotation Placement Trap](#2-the-annotation-placement-trap)
    - [3. Openers and Tone](#3-openers-and-tone)
    - [4. Constructor Linking](#4-constructor-linking)
    - [5. Out-of-Scope Links (@docImport)](#5-out-of-scope-links-docimport)
